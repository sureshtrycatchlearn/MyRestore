...
export const productSelector = productsAdaptor.getSelectors((state:RootState)=>state.catalog);
export const {setProductParams, resetsetProductParams, setMetaData, setPageNumber} = catalogSlice.actions;